...
const handelSchedule = async (e:React.FormEvent)=>{
  e.preventDefault()
  setLoading(true)
  ...
  return (
        ...
        <div>
          ...
          {PLATFORMS.map((p)=> {
            ...
            return (
              ...
              ${active ? "bg-red-50 border-red-300 text-red-500 scale-103":
    ...
    <div>
        ...
        <div className={`text-right text-xs mt-1 font-medium ${content.length > 270 ?
    ...
    <div>
      ...
      {mediaFile ? (
        <div className="relative rounded-xl overflow-hidden border border-slate-200 bg-slate-50">
           ...
           <img src={URL.createObjectURL(mediaFile)} alt="perview" className="w-full h-40 object-cover"/> 
          ...
          className="absolute top-2 right-2 size-7 bg-slate-900/60 hover:bg-slate-900/80 text-white
      ...
      border-2 border-dashed border-slate-200 rounded-xl cursor-pointer hover:border-red-300
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
      <div>
        ...
        <div className="relative">
           ...
           <input type="date" required className="w-full pl-10 pr-4 py-2.5 bg-slate-200 rounded-lg
            text-slate-900 text-sm outline-none" value={scheduled}
    ...
    <div>
        ...
        <div className="relative">
           <Calendar1Icon className="size-4 absolute left-3 top-1/2 -translate-y-1/2
            text-slate-400 pointer-events-none"/>
           <input type="time" required className="w-full pl-10 pr-4 py-2.5 bg-slate-200 rounded-lg
            text-slate-900 text-sm outline-none" value={scheduledTime}
...
<div className="max-h-72 overflow-y-auto divid-y divide-slate-50">
  {scheduled.length === 0 ? (
      ...
      <div key={post._id} className="px-5 py-4 hover:bg-slate-50/60 transition-colors">
          <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-2">
                   ...
                   border border-slate-200 px-1.5 py-0.5 rounded-md font-semibold capitalize"
                   >{post.mediaType}</span>} 
