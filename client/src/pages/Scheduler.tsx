        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-6">
          ...
          <form className="space-y-5" onSubmit={handleSchedule}>
            ...
            <div>
              ...
              {mediaFile ? (
                ...
                <label className="flex items-center justify-center gap-2 p-5 py-10 border-2 border-dashed border-slate-200 rounded-xl cursor-pointer hover:border-red-300 hover:bg-red-50/30 transition-all group">
                  <span className="text-sm text-slate-500">Click to upload image or video</span>
                  <input
                    type="file"
                    accept="image/*,video/*"
                    className="hidden"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="date"
                    required
                    className="w-full pl-10 pr-4 py-2.5 bg-slate-100 rounded-lg text-slate-900 text-sm outline-none"
                    value={scheduledDate}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3.5 bg-red-500 hover:bg-red-600 transition-all text-white rounded-lg font-medium"
            >
              {loading ? (
                <>
